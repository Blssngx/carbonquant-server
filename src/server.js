...
//   console.log('Received rules from frontend:', receivedRules);
//   const sRules = JSON.stringify(receivedRules);
//   console.log('Updated rules:', receivedRules.name);
...
//       sendTelegramMessage("6920662344:AAF8Z_3OiMqMyfbui7qZHAIEKjygsf46aOE", "916045875", message);
//     }
...
//   receivedRules.id = rules.length + 1;
//   rules.push(receivedRules);
